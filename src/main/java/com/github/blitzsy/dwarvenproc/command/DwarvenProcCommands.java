...
public class DwarvenProcCommands implements ICommand
{
    ...
    private void displayCommandItemInfo(ICommandSender sender, String[] args)
    {
        if (sender instanceof EntityPlayer)
        {
            ...
            {
                player.addChatComponentMessage(new TextComponentTranslation(Commands.ITEM_INFO_HEADER).setStyle(new Style().setColor(TextFormatting.WHITE)), false);
                player.addChatComponentMessage(new TextComponentTranslation(Commands.ITEM_INFO_MAIN_HAND), false);
                player.addChatComponentMessage(new TextComponentTranslation(Commands.ITEM_INFO_TYPE, " " + TextFormatting.BLUE + heldItemMainhand.getUnlocalizedName()).setStyle(new Style().setColor(TextFormatting.GREEN)), false);
                player.addChatComponentMessage(new TextComponentTranslation(Commands.ITEM_INFO_NAME, " " + TextFormatting.BLUE + heldItemMainhand.getDisplayName()).setStyle(new Style().setColor(TextFormatting.GREEN)), false);
                player.addChatComponentMessage(new TextComponentTranslation(Commands.ITEM_INFO_OFF_HAND), false);
                player.addChatComponentMessage(new TextComponentTranslation(Commands.ITEM_INFO_TYPE, " " + TextFormatting.BLUE + heldItemOffhand.getUnlocalizedName()).setStyle(new Style().setColor(TextFormatting.GREEN)), false);
                player.addChatComponentMessage(new TextComponentTranslation(Commands.ITEM_INFO_NAME, " " + TextFormatting.BLUE + heldItemOffhand.getDisplayName()).setStyle(new Style().setColor(TextFormatting.GREEN)), false);
            }
